...
public class OEMSWrapper<I extends OEMSHandler> implements Runnable, Closeable {
    ...
    public OEMSWrapper(String inputPath, String outputPath, I serviceImpl) {
        ...
        serviceOut = outputQueue.acquireAppender().methodWriter(OEMSPub.class);
