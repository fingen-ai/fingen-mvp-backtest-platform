...
public class PerfWrapper<I extends PerfHandler> implements Runnable, Closeable {
    ...
    public PerfWrapper(String inputPath, String outputPath, I serviceImpl) {
        ...
        serviceOut = outputQueue.acquireAppender().methodWriter(PerfPub.class);
