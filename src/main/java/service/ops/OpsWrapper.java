...
public class OpsWrapper<I extends OpsHandler> implements Runnable, Closeable {
    ...
    public OpsWrapper(String inputPath, String outputPath, I serviceImpl) {
        ...
        serviceOut = outputQueue.acquireAppender().methodWriter(OpsPub.class);
