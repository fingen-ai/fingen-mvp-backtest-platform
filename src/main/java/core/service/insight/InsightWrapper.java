...
public class InsightWrapper<I extends InsightHandler> implements Runnable, Closeable {
    ...
    public InsightWrapper(String inputPath, String outputPath, I serviceImpl) {
        ...
        serviceOut = outputQueue.acquireAppender().methodWriter(InsightPub.class);
