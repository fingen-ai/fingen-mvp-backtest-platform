...
public class PriceWrapper<I extends PriceHandler> implements Runnable, Closeable {
    ...
    public PriceWrapper(String inputPath, String outputPath, I serviceImpl) {
        ...
        serviceOut = outputQueue.acquireAppender().methodWriter(PricePub.class);
