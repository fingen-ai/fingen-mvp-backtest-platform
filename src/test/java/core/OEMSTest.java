...
public class OEMSTest {
    ...
    private void validateDTOAndQueuesIntegration(InsightData expected, OEMSData actual) {
        ...
        if(recCount == 405) {
            ...
            // OEMS data created as Insights via Order Mapping and InsightPub services
            assertNotEquals("Mismatch in some OEMS field", 0, actual.openOrderId);
            assertNotEquals("Mismatch in some OEMS field", 0, actual.openOrderTimestamp, 0.001);

            assertEquals("Mismatch in some Insight field", "GTC", actual.openOrderExpiry);
            assertEquals("Mismatch in some Insight field", "Ongoing New Order Single", actual.openOrderState);

            // OEMS data
            assertNotEquals("Mismatch in some OEMS field", 0, actual.closeOrderId);
            assertNotEquals("Mismatch in some OEMS field", 0, actual.closeOrderTimestamp);

            assertEquals("Mismatch in some Insight field", "GTC", actual.closeOrderExpiry);
            assertEquals("Mismatch in some Insight field", "Close Orders All", actual.closeOrderState);
        }
        ...
        if(recCount == 443) {
            ...
            // OEMS data
            assertNotEquals("Mismatch in some OEMS field", 0, actual.closeOrderId, 0.001);
            assertNotEquals("Mismatch in some OEMS field", 0, actual.closeOrderTimestamp, 0.001);
        ...
        if(recCount == 1068) {
            ...
            assertEquals("Mismatch in some Insight field", "Limit", actual.orderType);
            assertEquals("Mismatch in some Insight field", "Sell", actual.orderSide);
            assertEquals("Mismatch in some Insight field", 29, actual.openOrderQty, 0.001);
            assertEquals("Mismatch in some Insight field", "Sell", actual.openOrderSide);
        ...
        if(recCount == 1069) {
            ...
            assertEquals("Mismatch in some Insight field", "Limit", actual.orderType);
            assertEquals("Mismatch in some Insight field", "Buy", actual.orderSide);
            assertEquals("Mismatch in some Insight field", 29, actual.openOrderQty);
            assertEquals("Mismatch in some Insight field", "Buy", actual.openOrderSide);
